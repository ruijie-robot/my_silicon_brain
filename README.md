...
### Section 3
请阅读State_of_AI_in_Business 2025.pdf 和 Using_LLM_for_stock_valuation_analysis.pdf，并且结合可以搜索到的其他文献，简述公司不同基础建设的几个方面 （当你阐述的时候，需要清楚的标注出每一个结论的Reference，并把文件名或者链接放在Reference section里面）
